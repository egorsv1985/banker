 ...
 */
?>
<div class="singleBlog" itemscope itemtype="http://schema.org/Article">
    ...
    <? } ?>
  <div class="sblogDec">
    <h2 class="blogTitle"><a href="<?= ($this->showComments ? '#' : Yii::app()->controller->createUrl(
          '/blog/posts',
          ['id' => $blogData->id]
    ...
    <p>
                    <span itemprop="headline">
                        <?= Blogs::prepareBody($blogData->body, 360) ?>
                    </span>
    </p>
  </div>
  ...
  <a href="<?= Yii::app()->controller->createUrl(
    '/blog/posts',
    ['id' => $blogData->id]
  ) ?>" class="blogReadmore"><?= Yii::t('main', 'Читать') ?></a>
