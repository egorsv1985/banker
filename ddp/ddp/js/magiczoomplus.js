...
window.MagicZoom = (function () {
    ...
    w = y = (function () {
        ...
        var T = {}, L = navigator.userAgent.toLowerCase(), K = L.match(/(webkit|gecko|trident|presto)\/(\d+\.?\d*)/i),
            ...
            R = L.match(/version\/(\d+\.?\d*)/i), G = document.documentElement.style;
        ...
        var V = /\S+/g, J = /^(border(Top|Bottom|Left|Right)Width)|((padding|margin)(Top|Bottom|Left|Right))$/,
            O = {'float': ('undefined' === typeof (G.styleFloat)) ? 'cssFloat' : 'styleFloat'}, Q = {
                fontWeight: true,
                lineHeight: true,
                opacity: true,
                zIndex: true,
        ...
        G.prototype = {
            setupContent: function () {
                ...
                var O = {
                    ...
                    N = 'vertical' == this.settings.orientation ? 'y' : 'x', V = this.context.parentNode.jGetSize()[R],
                    S = this.context.parentNode.jGetPosition(), L = this.context.jGetSize()[R], U, J, Y, P, K, T, Q, X = [];
                if (this.scrollFX) {
                    this.scrollFX.stop();
                } else {
    ...
    var t, p = {}, D = h([]), F, e = window.devicePixelRatio || 1, E, x = true,
        f = y.jBrowser.features.perspective ? 'translate3d(' : 'translate(', A = y.jBrowser.features.perspective ? ',0)' : ')', m = null;
    ...
    function u() {
        ...
        I = setInterval(function () {
            var L = window.orientation == 90 || window.orientation == -90, K = window.innerHeight,
    ...
    j.prototype = {
        loadOptions: function (G) {
            ...
            var S, I, N = 30, K = 201, P, Q = '', H = {}, G, M, R = 0,
                T = {transition: y.jBrowser.cssTransform + String.fromCharCode(32) + '300ms cubic-bezier(.18,.35,.58,1)'}, J, O,
                L = h(function (U) {
